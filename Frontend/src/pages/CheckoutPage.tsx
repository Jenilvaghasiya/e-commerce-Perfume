      ...
      await addOrder(
        {
          ...
          items: items.map(item => ({
            ...
            image: item.image,
            customNotes: item.customNotes as any
          })) as any,
          total,
          status: 'Processing',
          shippingAddress: {
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-6 rounded-xl shadow-lg sticky top-8">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white py-4 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-60 disabled:cursor-not-allowed"
              >
