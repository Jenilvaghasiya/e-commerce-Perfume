        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-white">Ignite Perfume</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/shop" className="text-white hover:text-white transition-colors duration-200">
                  Shop
                </Link>
              </li>
              <li>
                <Link to="/customize" className="text-white hover:text-white transition-colors duration-200">
                  Customize
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-white hover:text-white transition-colors duration-200">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-white hover:text-white transition-colors duration-200">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white">info@igniteperfume.com</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white">123 Fragrance St, New York, NY 10001</span>
              </div>
            </div>
          </div>
        </div>
